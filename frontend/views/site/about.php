    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <p>Our technology stack is based mostly on web technologies and related areas, but are we also familiar in mobile development, cloud solutions,  and SEO.</p>
                <p>We have a wide network of partners in different professional areas, so any task can be fully estimated and solved.</p>
