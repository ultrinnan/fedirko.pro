...
if ($projects){
	foreach ($projects as $key => $value) {
		...
		$projects_list .= '<div class="col-md-6">
                <a href="/portfolio/view/' . $value['project_id'] .'" style="background: #39675a url(/images/projects/' . $value['project_id'] . '/' . $value['pictures']['main']['thumb'] . ') center no-repeat; background-size: cover;">
