    ...
    public function up()
    {
	    ...
	    $this->batchInsert(
		    ...
		    [
			    ...
			    [1, 2, 'My first site', 'Very first version of my portfolio site', 'Very first version of my portfolio site. But it was fast and effective.'],
			    ...
			    [2, 2, 'Professional Web Solutions', 'Website for professionals from Australia', 'Мой вклад: переделка шаблона, правка CSS, переделка верстки модулей, создание 25 картинок популярных технолгий, используемых компанией (доступно >тут<)'],
			    ...
			    [4, 2, 'Современные Технологии Строительства', 'Современные Технологии Строительства.', 'полная настройка CMS сайта, переделка/дорисовка шаблона, правка CSS, подключение/изменение модулей.'],
			    ...
			    [5, 2, 'Песональный сайт ивент-менеджера Арины Ткаченко', 'Песональный сайт ивент-менеджера Арины Ткаченко', 'корректировка шаблона, правка CSS, обновление и чистка движка, наполнение.'],
			    ...
			    [6, 2, 'Командный сайт киевского клуба ролевого моделирования "Вэльдрин"', 'Командный сайт киевского клуба ролевого моделирования "Вэльдрин"', 'полная настройка CMS сайта, переделка/дорисовка шаблона, правка CSS, подключение/изменение модулей, наполнение.'],
		    ]
	    );
    }
